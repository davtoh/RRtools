...
if __name__ == '__main__':
    ...
    #scaled_fore = cv2.bilateralFilter(scaled_fore,d,sigmaColor,sigmaSpace)
    #scaled_back = cv2.bilateralFilter(scaled_back,d,sigmaColor,sigmaSpace)
    original_fore = cv2.bilateralFilter(original_fore,d,sigmaColor,sigmaSpace)
    original_back = cv2.bilateralFilter(original_back,d,sigmaColor,sigmaSpace)
