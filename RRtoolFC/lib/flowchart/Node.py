    ...
    def restoreTerminals(self, state):
        ...
        for name, opts in list(state.items()):
            ...
            try:
                ...
                printExc("Error restore terminal %s (%s):" % (str(name), str(opts)))
...
class NodeGraphicsItem(GraphicsObject):
    def __init__(self, node):
        ...
        self.nameItem.moveBy(old_div(self.bounds.width(),2.) - old_div(self.nameItem.boundingRect().width(),2.), 0)
    ...
    def labelChanged(self):
        ...
        self.nameItem.setPos(old_div(bounds.width(),2.) - old_div(self.nameItem.boundingRect().width(),2.), 0)
